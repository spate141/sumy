...
def main(args=None):
    ...
    reference_document = PlaintextParser.from_string(reference_summary, Tokenizer(nlp=None, min_sen_len=3), None)
...
def handle_arguments(args):
    ...
    parser = parser(document_content, Tokenizer(nlp=None, min_sen_len=3))
